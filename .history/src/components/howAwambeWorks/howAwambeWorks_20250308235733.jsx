  ...
  return (
    <div className="container-adjustment-special-case">
      <div>
        ...
        <div className="d-flex flex-wrap-management col-12 heightAdjustment mt-5">
          <div className="d-flex" style={{height:"200px"}}>
            <div className="d-flex">
              <div className="text-center d-flex flex-column align-items-center ">
                ...
                <div className=" fs-11 fw-400" style={{minWidth:"163px"}}>Quickly sign up, then access your personalized planning dashboard.</div>
              </div>
              <div className="mt-5">
            ...
            <div className="d-flex align-self-end">
              <div className="text-center d-flex flex-column align-items-center ">
                ...
                <div className=" fs-11 fw-400" style={{minWidth:"163px"}}>Design and customize unique invitations with ease, then preview before sending</div>
              </div>
              <div className="mt-5">
                <img src={arrow} className='arrowShrink'/>
              </div>
          ...
          <div className="d-flex align-self-center" style={{height:"200px"}}>
            <div className="d-flex ">
              <div className="text-center d-flex flex-column align-items-center ">
                ...
                <div className=" fs-11 fw-400" style={{minWidth:"163px"}}>Easily upload and manage guest lists, and send automated reminders.</div>
              </div>
              <div className="mt-5">
                <img src={arrow} className='arrowShrink'/>
              </div>
            ...
            <div className="d-flex align-self-end">
              <div className="text-center d-flex flex-column align-items-center ">
                ...
                <div className=" fs-11 fw-400" style={{minWidth:"163px"}}>Book vendors directly, schedule events, and track your budget efficiently.</div>
              </div>
              <div className="mt-5">
                <img src={arrow} className='arrowShrink'/>
              </div>
          ...
          <div className="align-self-end text-center d-flex flex-column align-items-center ">
            <img src={gift} className='iconShrink'/>
            <div className="fs-16 fw-600 my-2 ">Gifts</div>
            <div className=" fs-11 fw-400" style={{minWidth:"163px"}}>Link your registry, receive secure gifts, and send automated thank-you notes.</div>
          </div>
        </div>
      </div>  
      <div> 
