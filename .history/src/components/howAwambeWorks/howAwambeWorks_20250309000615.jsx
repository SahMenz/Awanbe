...
function HowAwambeWorks() {
  ...
  return (
    <div className="container-adjustment-special-case">
      <div>
        <div className="d-flex align-items-center flex-column flex-xl-row justify-content-center text-center">
        ...
        <div className="d-flex gap-5 flex-column align-items-center col-12 heightAdjustment mt-5">
          <div className="d-flex align-self-xl-start" style={{height:"200px"}}>
          ...
          <div className="d-flex align-self-center" style={{height:"200px"}}>
            <div className="d-flex ">
              <div className="text-center d-flex flex-column align-items-center ">
