...
function HowAwambeWorks() {
  ...
  return (
    <div className="container-adjustment-special-case">
      <div>
        <div className="pb-4 pb-md-1 d-flex align-items-center flex-column justify-content-center text-center">
        ...
        <div style={{height:"60vw", maxHeight:"150px"}}></div>
        <div className="pt-5 d-flex justify-content-center gap-5 gap-xl-1 flex-column flex-xl-row align-items-center col-12 heightAdjustment mt-5">
          <div className="d-flex flex-column flex-sm-row align-self-xl-start" style={{height:"200px"}}>
            <div className="d-flex">
              <div className="text-center d-flex flex-column align-items-center ">
                <img src={register} className='iconShrink'/>
                <div className="fs-16 fw-600 my-2">Register</div>
                <div className=" fs-11 fw-400" style={{width:"163px"}}>Quickly sign up, then access your personalized planning dashboard.</div>
              </div>
              <div className="mt-5">
            ...
            <div className="d-flex align-self-end mt-3  mt-sm-1">
              <div className="text-center d-flex flex-column align-items-center ">
                ...
                <div className=" fs-11 fw-400" style={{width:"163px"}}>Design and customize unique invitations with ease, then preview before sending</div>
              </div>
              <div className="mt-5">
                <img src={arrow} className='arrowShrink'/>
              </div>
          ...
          <div className="d-flex flex-column flex-sm-row mt-5 mt-sm-1 align-self-center" style={{height:"200px"}}>
            <div className="d-flex ">
              <div className="text-center d-flex flex-column align-items-center ">
                <img src={guest} className='iconShrink'/>
                <div className="fs-16 fw-600 my-2">Guests</div>
                <div className=" fs-11 fw-400" style={{width:"163px"}}>Easily upload and manage guest lists, and send automated reminders.</div>
              </div>
              <div className="mt-5">
                <img src={arrow} className='arrowShrink'/>
              </div>
            ...
            <div className="d-flex align-self-end mt-3 mt-sm-1">
              <div className="text-center d-flex flex-column align-items-center ">
                ...
                <div className=" fs-11 fw-400" style={{width:"163px"}}>Book vendors directly, schedule events, and track your budget efficiently.</div>
              </div>
              <div className="mt-5">
                <img src={arrow} className='arrowShrink'/>
              </div>
          ...
          <div className="align-self-center mt-5 mt-sm-1  align-self-xl-end text-center d-flex flex-column align-items-center ">
            ...
            <div className=" fs-11 fw-400" style={{width:"163px"}}>Link your registry, receive secure gifts, and send automated thank-you notes.</div>
          </div>
        </div>
      </div>
      <div style={{height:"60vw", maxHeight:"170px"}}></div>
      <div className='pt-4 pt-mdl-1'> 
