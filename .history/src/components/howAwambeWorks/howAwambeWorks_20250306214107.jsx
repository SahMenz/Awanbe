      ...
      <div>
        ...
        <div className="d-flex flex-column align-items-center">
              <div
                ...
                aria-expanded={open}
                className="bg-eb flex-column d-flex mt-3 col-7 align-items-center justify-content-between"
                style={{
                  cursor: "pointer",
                  borderRadius: "20px",
                  height: open ? "" : "90px",
              ...
              <div
                ...
                aria-expanded={open1}
                className="bg-eb mt-3 flex-column d-flex align-items-center justify-content-between"
                style={{
                  cursor: "pointer",
                  borderRadius: "20px",
                  height: open1 ? "" : "90px",
