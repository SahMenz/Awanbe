  ...
  return (
    <div className="container-adjustment">
      <div>
        ...
        <div className="d-flex col-12 bg-00 heightAdjustment">
          <div className="d-flex" style={{height:"250px"}}>
            <div className="d-flex bg-ff" style={{width:"350px"}}>
          ...
          <div className="d-flex align-self-center" style={{height:"250px"}}>
            <div className="d-flex ">
              <div className="text-center d-flex flex-column align-items-center ">
                <img src={guest}/>
                <div className="fs-19 fw-600 my-2">Guests</div>
                <div className=" fs-13 fw-400" style={{minWidth:"163px"}}>Easily upload and manage guest lists, and send automated reminders.</div>
              </div>
              <div className="mt-5">
                <img src={arrow}/>
              </div>
            ...
            <div className="d-flex align-self-end">
              <div className="text-center d-flex flex-column align-items-center ">
                <img src={planning}/>
                <div className="fs-19 fw-600 my-2">Planning</div>
                <div className=" fs-13 fw-400" style={{minWidth:"163px"}}>Book vendors directly, schedule events, and track your budget efficiently.</div>
              </div>
              <div className="mt-5">
                <img src={arrow}/>
              </div>
          ...
          <div className="align-self-end text-center d-flex flex-column align-items-center ">
            <img src={gift}/>
            <div className="fs-19 fw-600 my-2">Gifts</div>
            <div className=" fs-13 fw-400" style={{minWidth:"163px"}}>Link your registry, receive secure gifts, and send automated thank-you notes.</div>
          </div>
        </div>
      </div>  
      <div> 
