  ...
  return (
    <div className="container-adjustment-special-case">
      <div>
        ...
        <div className="d-flex justify-content-center gap-5 gap-xl-1 flex-column flex-xl-row align-items-center col-12 heightAdjustment mt-5">
          ...
          <div className="align-self-center  align-self-xl-end text-center d-flex flex-column align-items-center ">
      ...
      <div style={{height:"20vw", minWidth:"200px"}}></div>
      <div> 
