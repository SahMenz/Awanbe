  ...
  return (
    <div className="container-adjustment">
      ...
      <div>
        ...
        <div
            className="d-flex flex-wrap gap-xl-4 px-xl-2 justify-content-center align-items-start"
            style={{ maxWidth: "1390px", gap: "30px" }}
          >
            <div
              className="d-flex flex-wrap gap-2  gap-xl-3 px-xl-2 justify-content-center"
              style={{
                width: "90vw",
                maxWidth: "553px",
              }}
            >
              <div
                ...
                aria-expanded={open}
                className="bg-eb flex-column d-flex align-items-center justify-content-between"
                style={{
                  cursor: "pointer",
                  borderRadius: "20px",
                  height: open ? "" : "90px",
              ...
              <div
                ...
                aria-expanded={open1}
                className="bg-ec flex-column d-flex align-items-center justify-content-between"
                style={{
                  cursor: "pointer",
                  borderRadius: "20px",
                  height: open1 ? "" : "90px",
              ...
              >
                <div>
                  ...
                  >
                    <div
                      ...
                      style={{ width: "70vw" }}
                    >
                      What are the job opportunities on Verion X?
                    </div>
                    {open5 ? (
                      <div>
                        <CustomSvg name="minus" />
                ...
                <Collapse in={open5}>
                  <div id="example-fade-text">
                    ...
                    >
                      Discover a world of opportunities at Verion X. Find your
                      dream job on Verion X. Explore countless job openings
                      across various industries. Detailed and Informative:
                      Verion X offers a diverse range of job opportunities
                      across industries such as technology, finance, healthcare,
                      and more. Find your ideal role and kickstart your career.
                      Looking for a new challenge? Verion X connects you with
                      exciting job openings tailored to your skills and
                      experience.
                    </div>
                  </div>
                </Collapse>
