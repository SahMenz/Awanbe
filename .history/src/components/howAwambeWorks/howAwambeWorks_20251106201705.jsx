    ...
    >
      <div>
        ...
        >
          ...
          {/* Step 1 & 2 Group */}
          <div
            className="d-flex flex-column flex-sm-row align-self-xl-start margin-top-gap1"
            style={{ height: "200px" }}
          >
            {/* Step 1: Register */}
          ...
          {/* Step 3 & 4 Group */}
          <div
            className="d-flex flex-column flex-sm-row mt-5 mt-sm-1  align-self-center margin-top-gap2"
            style={{ height: "200px" }}
          >
            {/* Step 3: Guests */}
            <motion.div className="d-flex" variants={itemVariants}>
          ...
          {/* Step 5: Gifts */}
          <motion.div className="align-self-center mt-5 mt-sm-1 margin-top-gap3  align-self-xl-end text-center d-flex flex-column align-items-center " variants={itemVariants}>
