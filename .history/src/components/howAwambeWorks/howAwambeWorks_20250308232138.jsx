          ...
          <div>
            <div>
              <div className="text-center">
                <img src={register}/>
                <div className="fs-19 fw-400">Register</div>
                <div className="col-2 fs-13 fw-400" style={{minWidth:"163px"}}>Quickly sign up, then access your personalized planning dashboard.</div>
              </div>
              <img src={arrow}/>
            </div>
            {/* <div></div> */}
