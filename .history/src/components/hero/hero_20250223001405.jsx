...
function Hero() {
  return (
    <div className="d-flex flex-column align-items-center bg-f5">
      ...
      <div></div>
      <button className="bg-a0 fs-19 fw-400 txt-ff mt-5 d-flex justify-content-center" style={{padding:"17px 35px", maxWidth:"360px",borderRadius:"30px"}}>Start planning today <CustomSvg name="arrowRight"/></button>
    </div>
  );
}
