...
function Hero() {
  return (
    <div className="">
      ...
      <div></div>
      <button className="bg-a0 fs-19 fw-400 txt-ff mt-5 text-center" style={{padding:"17px 30px", borderRadius:"30px"}}>Start planning today <CustomSvg name="arrowRight"/></button>
    </div>
  );
}
