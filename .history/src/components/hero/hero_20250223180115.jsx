...
function Hero() {
  return (
    <div className="d-flex flex-column pt-4 align-items-center bg-f5">
      ...
      <button className="bg-a0 fs-19 fw-400 txt-ff my-5 d-flex justify-content-center" style={{padding:"17px 40px", maxWidth:"360px",borderRadius:"30px"}}>Start planning today <CustomSvg name="arrowRight"/></button>
    </div>
  );
}
