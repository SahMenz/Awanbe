...
function Hero() {
  return (
    <div className="d-flex flex-column pt-4 align-items-center bg-f5">
      <div className="bg-f5 d-flex align-items-center flex-column text-center">
      ...
      <button className="bg-a0 fs-19 fw-400 txt-ff mt-5 d-flex justify-content-center" style={{padding:"17px 40px", maxWidth:"360px",borderRadius:"30px"}}>Start planning today <CustomSvg name="arrowRight"/></button>
    </div>
  );
}
