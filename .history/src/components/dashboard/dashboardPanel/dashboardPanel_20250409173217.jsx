...
function DashboardPanel() {
  return (
    <div>
      <div className="bg-ff d-flex align-items-center flex-column mb-4" style={{ width: "fit-content", borderRadius:"16px", paddingBottom:"160px" }}>
      ...
      <div className="bg-ff fs-500 fs-19" style={{ width: "fit-content", borderRadius:"16px" ,minWidth:"173px" }}>
        <div className="d-flex align-items-center p-3">
