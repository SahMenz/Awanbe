...
function DashboardPanel() {
  return (
    <div>
      <div className="bg-ff d-flex align-items-center flex-column" style={{ width: "fit-content", borderRadius:"16px" }}>
        {/* <div style={{width:"130px"}}> */}
          <img src={logoNameB} style={{width:"130px", color:"#A04D07", margin:"31px 0px 100px 0px"}}/>
        {/* </div> */}
        <div className="fs-500 fs-19 txt-73">
      ...
      <div className="bg-ff txt-73" style={{ width: "fit-content" }}>
        <div className="d-flex align-items-center p-3">
