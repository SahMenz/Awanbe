  ...
  return (
    ...
    >
      ...
      <Modal.Body className="bg-f7 txt-a0">
        ...
        <div className="mt-4">
          <p className="txt-00 fs-23 fw-400">Photography Style <span className="txt-73"> (Multiple selection available)</span></p>
          <div className="gap-3 fs-16 fw-400 d-flex align-items-center flex-wrap justify-content-center justify-content-md-start">
            <button className="items">Editorial</button>
            <button className="items">Classical</button>
            <button className="items">Drone Photography</button>
            <button className="items">Food Photography</button>
            <button className="items">Fashion Photography</button>
            <button className="items">Photo journalistic</button>
            <button className="items">Fine Art</button>
            <button className="items">Others</button>
          </div>
        </div>

        <div className="mt-5">
          <p className="txt-00 fs-23 fw-400">Service <span className="txt-73"> (Multiple selection available)</span></p>
          <div className="gap-3 fs-16 fw-400 gap-3 d-flex align-items-center flex-wrap justify-content-center justify-content-md-start">
