import { BiFilter, BiFilterAlt, BiSearch } from "react-icons/bi";
  ...
  return (
    <div className="ms-5">
      ...
      <div className="d-flex align-items-center justify-content-between mb-3">
        <IoFilter size={22}/>
        <BiSearch size={22} />
        <input type="search" placeholder="Search for venue" className="col-6"/>
        <button className="bg-a0 txt-ff" style={{padding:"13px 50px", borderRadius:"40.6px"}}>Search</button>
      </div>
