...
function VenueScreen() {
  return (
    <div className="ms-5">
      ...
      <div className="d-flex my-4 bg-ff align-items-center justify-content-between" style={{ padding: "0px 8px 0px 0px", borderRadius: "40.6px" }}>
        ...
        <button
          className="bg-a0 txt-ff d-none d-sm-block"
