            ...
            <div className='d-flex gap-5 align-items-center fs-16 fw-500 col-6'>
                {navLinks.map((nav) => (
                    <NavLink
                        ...
                        className={({ isActive }) => 
                            `pb-3 cursor-pointer ${isActive ? 'txt-a0 text-decoration-none border-bottom-a0 fw-600' : 'txt-73'}` // Assuming 'txt-a0' and 'border-bottom-a0' are styles for active state
                        }
                        style={{
