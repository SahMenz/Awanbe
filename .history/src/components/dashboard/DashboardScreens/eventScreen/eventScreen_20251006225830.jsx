...
import AllEvents from "./allEvents"; // Assuming this is imported correctly

// Placeholder components (you should define these in their own files)
...
function EventScreen() {
    ...
    return (
        <div className="ms-3 w-100">
            ...
            {/* NESTED EVENT ROUTES */}
            <Routes>
                {/* The default route for /dashboard/events and /dashboard/events/all */}
