      ...
      <Modal.Body className="bg-f7 txt-a0">
        ...
        <div className="mt-5">
          ...
          <div className="gap-3 fs-16 fw-400 gap-3 d-flex align-items-center flex-wrap justify-content-center justify-content-md-start">
            <button className="items">Conference Centers</button>
            <button className="items">Hotels & Resorts</button>
            <button className="items">Coworking Spaces</button>
            <button className="items">Auditoriums & Theaters</button>
            <button className="items">Banquet Halls</button>
            <button className="items">Ballrooms</button>
            <button className="items">Lounge</button>
            <button className="items">Gardens & Parks</button>
            <button className="items">Beaches & Waterfront</button>
            <button className="items">Museums & Art Galleries</button>
            <button className="items">Convention Centers</button>
            <button className="items">Others</button>
          </div>
        </div>
        ...
        <div className="mt-5">
          ...
          <div className="gap-3 fs-16 fw-400 gap-3 d-flex align-items-center flex-wrap justify-content-center justify-content-md-start">
            <button className="items">Up to 50</button>
            <button className="items">50 - 100</button>
            <button className="items">100 - 300</button>
            <button className="items">300 - 500</button>
            <button className="items">500 - 700</button>
            <button className="items">700 - 1000</button>
            <button className="items">1000 and Above</button>
          </div>
        </div>
