function Settings() {
  return (
    <div className="ms-4 txt-a0 w-100">
      ...
      <div style={{border:"0.2px solid #737373", borderRadius:"24px", padding:"8px 16px"}}>
        <div>
          <div style={{}}>

          </div>
          <div className="ms-3">
            <p className="fs-19 fw-500 txt-a0">Anne Godiva</p>
            <p className="fs-16 fw-400 txt-73">annegodiva@gmail.com</p>
          </div>
        </div>
        {/* <div></div> */}
      </div>
