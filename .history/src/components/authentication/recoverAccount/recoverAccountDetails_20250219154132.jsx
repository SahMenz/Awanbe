...
function RecoverAccountDetails() {
  return (
    <div className="d-flex m-4 m-lg-0">
      {/* <div className=''> */}
      <div className="p-5 pt-5 d-flex flex-column col-12 col-lg-6 text-center">
        <div>
          <img src={logoName} />
        ...
        <div
          className="my-4 text-start d-flex align-items-center bg-f3 fw-500 fs-16 p-3"
          style={{ borderRadius: "25px", minWidth: "280px" }}
        >
          <img
            src={profile}
