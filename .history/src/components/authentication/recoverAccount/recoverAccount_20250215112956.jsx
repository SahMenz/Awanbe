  ...
  return (
    <div className='d-flex justify-content-center align-items-center justify-content-xl-between m-4 m-xl-0'>
        <div className='p-5 pt-5 d-flex flex-column  text-center'>
          ...
          <button className='txt-00 text-decoration-none mt-5 mb-3 fw-600 fs-23 py-3' style={{minWidth:"300px",borderRadius:"50px",backgroundColor:"#A04D07", color:"white"}}><Link to="/recover-account">Continue</Link></button>
        </div>
