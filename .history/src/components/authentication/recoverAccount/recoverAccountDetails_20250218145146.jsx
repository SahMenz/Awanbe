    ...
    <div className='d-flex justify-content-center justify-content-xl-between m-4 m-xl-0'>
      {/* <div className=''> */}
        <div className='p-5 pt-5 d-flex flex-column  text-center'>
          ...
          <Link to="/recovered-account" className='mt-5 mb-3 fw-600 fs-23 py-3 bg-a0' style={{minWidth:"300px",borderRadius:"50px"}}><button className='bg-a0' >Continue</button></Link>
        </div>
      {/* </div> */}
