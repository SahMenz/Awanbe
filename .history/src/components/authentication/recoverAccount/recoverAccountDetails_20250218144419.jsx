    ...
    <div className='d-flex justify-content-center justify-content-xl-between m-4 m-xl-0'>
      {/* <div className=''> */}
        <div className='p-5 pt-5 d-flex flex-column  text-center'>
          ...
          <Link to="/recovered-account" className='mt-5 mb-3 fw-600 fs-23 py-3 bg-trans' style={{minWidth:"300px",borderRadius:"50px",backgroundColor:"#A04D07", color:"white"}}><button className='' >Continue</button></Link>
        </div>
      {/* </div> */}
