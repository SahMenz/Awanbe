  ...
  return (
    <div className='d-flex justify-content-between'>
      <div className='d-flex flex-column justify-content-center text-center'>
        ...
        <div className='d-flex bg-f3 fw-500 fs-16 p-3 text-start' style={{borderRadius:"25px"}}>
          <img src={password} style={{backgroundColor:"#f3f3f3", marginRight:"8px"}}/>
          <input type="email" placeholder="Password" className='bg-f3 me-3'/>
          <img src={cancelledEyes} style={{justifySelfSelf:"end",backgroundColor:"#f3f3f3", marginRight:"8px"}}/>
        </div>
