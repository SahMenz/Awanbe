...
// Assuming SchemaValidation path is correct relative to the component
...
function SignUp() {
  const initialValues = {
    ...
    email: "",
    password: "",
    confirmPassword: "", // Added confirmPassword to initialValues
  };
  ...
  const handleSignUpSubmission = (values, { setSubmitting }) => {
    // Simulate API call for signup
    console.log("Attempting signup with:", values);
    setSubmitting(true);

    // In a real application, you would make an async API call here
    setTimeout(() => {
      // Create user data from form values, minus the password/confirm fields
      const { password, confirmPassword, ...userData } = values; 

      // 1. Dispatch the setUser action to update Redux state
      dispatch(setUser(userData));

      setSubmitting(false);
      
      // 2. Navigate to dashboard after successful state update
      navigate("/dashboard");
    }, 1000);
  };
  ...
  return (
    <div className="d-flex m-4 m-lg-0">
      <div className="p-5 pt-5 d-flex flex-column  text-center col-12 col-lg-5">
        ...
        >
          {({ isSubmitting }) => ( // Destructure isSubmitting for the button
            <Form className="d-flex flex-column">
              ...
              <div
                className=" text-start d-flex align-items-center bg-f3 my-4 fw-500 fs-16 p-3"
                style={{ borderRadius: "25px", minWidth: "280px" }}
              >
                <img
                  src={profile}
              ...
              <div
                className="bg-f3 d-flex align-items-center mb-4 fw-500 fs-16 p-3 text-start"
                style={{ borderRadius: "25px", minWidth: "300px" }}
              >
                <img
                  src={password}
                ...
                >
                  {confirmPasswordVisible ? (
                    <IoMdEye size={17} color="black" /> // Use confirmPasswordVisible state here
                  ) : (
                    <CustomSvg name="cancelledEyes" />
                  )}
                </div>
              ...
              <button
                ...
                style={{
                  ...
                  color: "white",
                  opacity: isSubmitting ? 0.7 : 1, // Visual feedback for loading
                }}
              >
