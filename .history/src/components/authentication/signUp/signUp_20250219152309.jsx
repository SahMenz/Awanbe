...
function SignUp() {
  return (
    <div className='d-flex justify-content-center m-4 m-xl-0'>
      {/* <div className=''> */}
        <div className='p-5 pt-5 d-flex flex-column  text-center col-12 col-xl-6'>
          <div>
            <img src={logoName}/>
          ...
          <button className='mt-5 mb-3 fw-600 fs-23 py-3' style={{minWidth:"300px",borderRadius:"50px",backgroundColor:"#A04D07", color:"white"}}>Sign up </button>
          <div className='fs-16 fw-400'>Don’t have an Account? <b><Link to="/login" className='text-decoration-none txt-00'>Sign in</Link></b></div>
        </div>
      {/* </div> */}
      <img src={authImage} className='authImage d-none d-xl-flex col-xl-6'/>
    </div>
  )
}
