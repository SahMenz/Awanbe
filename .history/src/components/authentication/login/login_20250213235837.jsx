...
function Login() {
  return (
    <div className='d-flex justify-content-xl-between justify-content-center m-4 m-xl-0'>
      {/* <div className=''> */}
        <div className='p-5 pt-5 justify-self-center  d-flex flex-column text-center'>
          <div>
            <img src={logoName}/>
      ...
      {/* </div> */}
      <img src={authImage} className='authImage d-none d-xl-block'/>
    </div>
  )
}
