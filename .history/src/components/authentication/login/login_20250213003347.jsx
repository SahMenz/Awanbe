      ...
      {/* <div className=''> */}
        <div className='p-5 pt-5  d-flex flex-column text-center'>
          ...
          <div className=' text-start bg-f3 fw-500 fs-16 p-3' style={{borderRadius:"25px", minWidth:"280px"}}>
            ...
            <input type="email" placeholder="Email" style={{width:"20vw", minWidth:"200px"}} className='bg-73 txt-73 fs-17 fw-500'/>
          </div>
          <div className='bg-f3 my-4 fw-500 fs-16 p-3 text-start' style={{borderRadius:"25px", minWidth:"300px"}}>
            ...
            <input type="email" placeholder="Password" style={{width:"20vw", minWidth:"200px"}} className='bg-73 txt-73 fs-17 fw-500'/>
