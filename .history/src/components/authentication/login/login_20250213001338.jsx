...
function Login() {
  return (
    <div className='d-flex'>
      <div className='w-50 d-flex p-4 pt-5 justify-content-center'>
        <div className='w-50 d-flex flex-column  text-center'>
          ...
          <div className=' text-start bg-f3 fw-500 fs-16 p-3' style={{borderRadius:"25px"}}>
            ...
            <input type="email" placeholder="Email" className='bg-f3 txt-73 fs-17 fw-500'/>
          </div>
          <div className='bg-f3 my-4 fw-500 fs-16 p-3 text-start' style={{borderRadius:"25px"}}>
            ...
            <input type="email" placeholder="Password" className='bg-f3 me-3 txt-73 fs-17 fw-500'/>
            <img src={cancelledEyes} style={{position:"relative", right:"30",backgroundColor:"#f3f3f3"}}/>
          </div>
