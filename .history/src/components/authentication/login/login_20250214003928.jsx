    ...
    <div className='d-flex justify-content-center justify-content-xl-between m-4 m-xl-0'>
      {/* <div className=''> */}
        <div className='p-5 pt-5 d-flex flex-column  text-center'>
          ...
          <div className='bg-f3 d-flex align-items-center justify-content-between my-4 fw-500 fs-16 p-3 text-start' style={{position:"absolute",borderRadius:"25px", minWidth:"300px"}}>
            <img src={password} style={{backgroundColor:"#f3f3f3", marginRight:"8px"}}/>
            <input type="email" placeholder="Password" style={{width:"20vw", minWidth:"200px", position:"relative", lefti:"0px"}} className='bg-f3 txt-73 fs-17 fw-500'/>
