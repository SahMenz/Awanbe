    ...
    <div className="d-flex m-4 m-lg-0">
      <div className="p-5 pt-5 d-flex flex-column text-center col-lg-5 col-12">
        ...
        >
          ...
          />
          <img src={cancelledEyes} alt="Cancelled Eyes" style={{ backgroundColor: "#f3f3f3" }} />
        </div>
        <Formik
          initialValues={initialsValues}
          validationSchema={loginValidationSchema}
        >
          {/* {({ isValid, dirty }) => ( // Added this line to access Formik props */}
            <Form>
      ...
      <img src={authImage} alt="Auth Image" className="col-lg-7 d-none d-lg-flex" />
    </div>
  );
}
