          ...
          {({ isValid, dirty }) => (
            <Form className="w-100">
              <div className="mb-4 w-100">
                {/* <div
                  className="w-100 rounded-3 fw-400 lh-27 bg-f3 d-flex align-items-center"
                  style={{
                    padding: "12px 25px",
                  }}
                >
                  <div style={{ width: "7%" }}>
                    <CustomSvg name="mail" width={"25px"} height={"25px"} />
                  </div>
                  <div style={{ width: "88%" }} className="ms-3">
                    <Field
                      type="email"
                      name="email"
                      placeholder="Email"
              ...
              <div className="w-100 mb-4">
                <div
                  className="fw-400 w-100 rounded-3 lh-27 bg-f3 d-flex align-items-center"
                  style={{
                    padding: "12px 25px",
                  }}
                >
                  <div style={{ width: "7%" }}>
                    <CustomSvg name="password" width={"25px"} height={"25px"} />
                  </div>
                  <div style={{ width: "82%" }} className="ms-3">
                    <Field
                  ...
                  >
                    {passwordVisible ? (
                      <IoMdEye size={20} color="#EB1C25" />
                    ) : (
                      <CustomSvg name="hiddenPassword" />
                    )}
                  </div>
                </div>
                <ErrorMessage
              ...
              <div className="w-100 d-flex align-items-center justify-content-center w-100">
                <Link
                  ...
                  className="txt-f3 fw-400 txt-15 text-center lh-32 mt-4 mb-5"
                >
                  Forgot password?
                </Link>
              </div>
              {!isPending && (
                <button
                  ...
                  type="submit"
                  className="fw-500 txt-17 w-100 lh-27 bg-eb txt-ff text-center"
                  style={{
                    padding: "18px 0px",
                    borderRadius: "30px",
                ...
                >
                  Log in with Verion X
                </button>
              )}
              {isPending && <CustomLoading1 loadingTxt={"loggin in..."} />}
            </Form>
          )}
        </Formik>
        <Link
