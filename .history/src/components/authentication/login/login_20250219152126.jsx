...
function Login() {
  return (
    ...
    <div className='d-flex justify-content-center m-4 m-xl-0'>
      {/* <div className=''> */}
        <div className='p-5 pt-5 d-flex flex-column  text-center col-xl-6 col-12'>
          <div>
            <img src={logoName}/>
          ...
          <Link to="/recover-account-email" className='txt-00 text-decoration-none align-self-end fs-16 fw-400'>
            Forgot password?
          </Link>
          ...
          <div className='fs-16 fw-400'>Don’t have an Account? <b><Link to="/sign-up"  className="text-decoration-none txt-00">Sign up</Link></b></div>
        </div>
      {/* </div> */}
      <img src={authImage} className='col-xl-6 authImage d-none d-xl-flex'/>
    </div>
  )
}
