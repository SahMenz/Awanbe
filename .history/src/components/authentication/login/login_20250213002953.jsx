    ...
    <div className='d-flex justify-content-center'>
      {/* <div className=''> */}
        <div className='w-50 p-5 pt-5  d-flex flex-column text-center'>
          ...
          <div className=' text-start bg-f3 fw-500 fs-16 p-3' style={{borderRadius:"25px", minWidth:"280px"}}>
          ...
          <div className='bg-f3 my-4 fw-500 fs-16 p-3 text-start' style={{borderRadius:"25px", minWidth:"300px"}}>
            <img src={password} style={{backgroundColor:"#f3f3f3", marginRight:"8px"}}/>
            <input type="email" placeholder="Password" style={{width:"20vw", minWidth:"200px"}} className='bg-00 txt-73 fs-17 fw-500'/>
            <img src={cancelledEyes} style={{backgroundColor:"#f3f3f3"}}/>
          </div>
          <div className='align-self-end fs-16 fw-400'>
            Forgot password?
          </div>
          <button className='mt-5 mb-3 fw-600 fs-23 py-3' style={{minWidth:"200px",borderRadius:"50px",backgroundColor:"#A04D07", color:"white"}}>Sign in </button>
