    ...
    <div className="mt-4 container-adjustment">
      <div>
        <div className="d-flex gap-4 justify-content-between">
          <div className="fw-500 fs-43" style={{minWidth:"400px"}}>
            Merging <span className="txt-a0">Tradition</span> and <span className="txt-a0">Innovation</span> to Craft <span className="txt-a0">Unforgettable</span>
            Celebrations.
          </div>
          <div className="fs-16 fw-400" style={{minWidth:"300px"}}>
