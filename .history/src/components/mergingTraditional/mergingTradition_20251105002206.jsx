// FIX: Replaced failing image imports with placeholder URLs to allow the component to compile and display.
// import theChallenge from "../../assets/images/theChallenge.png";
// import ourResources from "../../assets/images/ourResources.png";
const theChallenge = "https://placehold.co/600x400/1E3A8A/FFFFFF?text=Challenge+Image";
const ourResources = "https://placehold.co/600x400/059669/FFFFFF?text=Response+Image";
...
function MergingTradition() {
  return (
    ...
    // FIX 1: Added 'overflow-x-hidden' to the main container. This is crucial to clip any content that briefly
    // extends horizontally, especially during the Framer Motion 'slide in' animation (x: 50).
    <motion.div 
      className="mt-4 container-adjustment overflow-x-hidden"
      initial="hidden"
      whileInView="visible"
    ...
    >
      <div>
        ...
        >
          ...
          <motion.div 
            // FIX 2: Replaced the fixed col-xxl-6 class with flex-1. This ensures the two cards equally share the
            // available space and correctly account for the gap-3 between them, preventing overflow.
            className="d-flex gap-3 col-12 flex-column flex-sm-row flex-1"
            variants={cardItemVariants}
          >
            {/* Image src updated to use placeholder variable */}
            <img src={theChallenge} alt="Image representing the challenge" className="col-6 col-md-4"/>
            <div
              className="d-flex bg-f5 flex-column flex-1"
          ...
          <motion.div 
            // FIX 2: Replaced col-xxl-6 with flex-1.
            className="d-flex gap-3 col-12 flex-column flex-sm-row flex-1"
            variants={cardItemVariants}
          >
            {/* Image src updated to use placeholder variable */}
