...
function MergingTradition() {
  ...
  // `once: true` ensures the animation plays only once (standard practice for scroll-based intros)
  // If you want it to replay every time it scrolls into view, set 'once: false'
  // `amount: 0.5` means the animation starts when 50% of the element is visible
