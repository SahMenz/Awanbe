  ...
  return (
    <div className="mt-4 container-adjustment">
      <div>
        ...
        <div className="mt-5 d-flex align-items-start justify-content-center gap-3 flex-wrap flex-xl-nowrap justify-content-md-between">
          <div className="d-flex gap-3 col-12 col-xl-6">
