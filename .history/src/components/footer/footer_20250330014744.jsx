  ...
  return (
    <div className="container-adjustment gap-5 bg-a0 py-5 footerBackgroundImage txt d-flex justify-content-start flex-wrap justify-content-lg-between">
      ...
      <div>
        ...
        <div onClick={onAboutUsClick} className="fw-19 fw-500 txt-eb">About us</div>
        <div onClick={onSolutionsClick} className="fw-19 fw-500 txt-eb my-3">Our solution</div>
        <div onClick={onHowWeWorkClick} className="fw-19 fw-500 txt-eb">How it works</div>
      </div>
      <div>
        <div className="fw-23 fw-800 txt-f5f">Quick Links</div>
