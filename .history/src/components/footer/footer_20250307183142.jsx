...
function Footer() {
  return (
    <div className="container-adjustment bg-a0 py-5 footerBackgroundImage txt d-flex justify-content-center flex-wrap justify-content-lg-between">
      <div>
        <div>
          <img src={footerLogo} />
        </div>
        <div className="my-3 fs-19 fw-500 txt-f5f" style={{maxWidth:"329px"}}>
