  ...
  return (
    <div className="container-adjustment gap-5 bg-a0 py-5 footerBackgroundImage txt d-flex justify-content-start flex-wrap justify-content-lg-between">
      ...
      <div>
        ...
        <div onClick={onHomeClick} className="cursor fw-19 fw-500 txt-eb my-3">
          Home
        </div>
        <div onClick={onAboutUsClick} className="cursor fw-19 fw-500 txt-eb">
          About us
        </div>
        <div
          onClick={onSolutionsClick}
          className="cursor fw-19 fw-500 txt-eb my-3"
        >
          Our solution
        </div>
        <div onClick={onHowWeWorkClick} className="cursor fw-19 fw-500 txt-eb">
          How it works
        </div>
      </div>
      <div>
