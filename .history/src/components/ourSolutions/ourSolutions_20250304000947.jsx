    ...
    <div className="container-adjustment mt-5">
      ...
      <div className="mb-5 d-flex align-items-center justify-content-center">
        <div className="mt-5 py-5  w-75 bg-a0 d-flex flex-column align-items-center text-center creatingAccess">
          ...
          <div
            className="w-75 gap-3 m-5 d-flex justify-content-between bg-ff mt-lg-5 mt-4"
            style={{
              minWidth: "240px",
              borderRadius: "30px",
          ...
          >
            <input
              ...
              style={{ width: "47vw", maxWidth: "455px" }}
            />
            <button
          ...
          <button
            className="w-50 bg-a0 txt-ff d-xl-none fw-400 fs-19"
            style={{
              backgroundColor: "#A04D07",
              padding: "12px 20px",
              borderRadius: "20px",
