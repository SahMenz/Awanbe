  ...
  return (
    <div className="container-adjustment mt-5">
      ...
      <div className="mb-5 d-flex align-items-center justify-content-center">
        <div className="mt-5 py-4 w-75 bg-a0 d-flex flex-column align-items-center text-center creatingAccess">
          ...
          >
            ...
            />
            <button
              className="w-50 bg-a0 txt-ff d-none d-md-block lh-22 fw-400 fs-19"
