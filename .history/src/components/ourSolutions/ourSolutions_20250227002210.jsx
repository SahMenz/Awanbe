  ...
  return (
    <div className="container-adjustment mt-5">
      ...
      <div className="mb-5 d-flex align-items-center justify-content-center">
        <div className="bg-a0 d-flex flex-column justify-content-between getGeneral text-center">
          <div className="fw-500 fs-45 text-center">
            Subscribe for Exclusive Updates and Notifications.
          </div>
          <div
            className="d-flex bg-ff mt-lg-5 mt-4 getSubscriber"
            style={{ borderRadius: "30px", padding: "9px 9px 9px 30px" }}
          >
            <input
              type="email"
            ...
            />
            <button
              className="bg-eb txt-ff d-none d-md-block lh-22 fw-400 txt-19 getSubscriberButton"
              style={{backgroundColor:"#A04D07" ,padding: "12px 40px", borderRadius: "20px" }}
            >
              Get Notified
            </button>
          </div>
