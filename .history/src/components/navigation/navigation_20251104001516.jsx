  ...
  return (
    <div className="d-flex fixed-top bg-ff container-adjustment justify-content-between align-items-center">
      ...
      <div className="d-flex align-items-center w-50 justify-content-between d-lg-flex d-none">
        ...
        {/* Desktop Nav Links: Added 'nav-link-item' class for animation */}
        <NavLink
          to="/" 
          onClick={handleHomeClick}
          // Removed inline style for isActive, now handled by CSS
      ...
      {/* Sign In/Sign Up buttons (Desktop) - No changes to animation */}
      ...
      {/* Mobile Menu/Offcanvas Trigger - No changes */}
      <div
        onClick={handleShow}
        className=" d-lg-none"
        style={{
        ...
        <Offcanvas.Body>
          ...
          >
            ...
            >
              ...
              {/* Mobile Nav Links: Changed class to 'nav-link-item-mobile' for unique styling */}
              <NavLink
                to="/"
                onClick={() => { handleHomeClick(); handleClose(); }} 
                // Removed inline style for isActive, now handled by CSS
                className="txt-16 lh-19 fw-600 text-decoration-none nav-link-item-mobile"
                end
              >
                Home
              </NavLink>
            ...
            {/* Mobile Sign In/Sign Up buttons - No changes */}
