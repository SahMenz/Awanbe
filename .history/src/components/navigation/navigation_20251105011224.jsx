...
function Navigation({ onHomeClick, onSolutionsClick, onAboutUsClick, onHowWeWorkClick, sectionRefs }) {
  ...
  return (
    // Main container has fixed-top, justifying content between
    <div className="d-flex fixed-top bg-ff container-adjustment justify-content-between align-items-center">
      ...
      {/* Desktop Navigation Links - HIDDEN below lg (992px) */}
      ...
      {/* Desktop Sign In/Sign Up Buttons - HIDDEN below lg (992px) */}
      ...
      {/* Hamburger menu icon logic - VISIBLE below lg (992px) */}
      {/* The class **d-lg-none d-block** ensures it is hidden on lg screens and up, but visible otherwise (d-block for general visibility) */}
      <div
        onClick={handleShow}
        className="**d-lg-none d-block** nav-hamburger-icon"
      >
