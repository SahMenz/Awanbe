...
function Navigation({ scrollToAboutUs, scrollToOurSolution, scrollToFooter, scrollToHowItWorks,
}) {
  const navLinks = [
    {
      title: "Home",
  ...
  return (
    <div className="d-flex container-adjustment justify-content-between align-items-center">
      ...
      <div
        style={{ gap: "20px" }}
        className="d-lg-flex d-md-none d-none align-items-center justify-content-between col-lg-6"
      >
        {displayNavLinks}
      </div>
