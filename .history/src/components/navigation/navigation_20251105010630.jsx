...
function Navigation({ onHomeClick, onSolutionsClick, onAboutUsClick, onHowWeWorkClick, sectionRefs }) {
  ...
  return (
    <div className="d-flex fixed-top bg-ff container-adjustment justify-content-between align-items-center">
      ...
      {/* Desktop Navigation Links - Hidden on screens smaller than large (lg) */}
      <div className="d-flex align-items-center w-50 justify-content-between d-none d-lg-flex">
        {/* Home */}
        <Link
          to="/" 
      ...
      {/* Desktop Sign In/Sign Up Buttons - Hidden on screens smaller than large (lg) */}
      ...
      {/* Hamburger Menu Icon:
        The logic here ensures the hamburger icon (which triggers the Offcanvas) 
        is visible on all screen sizes *except* large (lg) and up.
      */}
      <div
        onClick={handleShow}
      ...
      >
        ...
        <Offcanvas.Body>
          <div
            className="bg-ff pt-4 pb-4 d-flex flex-column justify-content-center align-items-center nav-offcanvas-content"
          >
            <div
            ...
            >
              ...
              <Link
                to="/"
                // Added handleClose to close the menu after clicking a link
              ...
              <Link
                ...
                className={`hovering txt-16 lh-19 fw-600 text-decoration-none nav-link-mobile ${getActiveSection("About us")}`}
              >
                About us
              </Link>
              {/* Our solution link */}
            ...
            {/* Sign In/Sign Up buttons in Offcanvas */}
