...
function Navigation({onHomeClick,onSolutionsClick, onAboutUsClick, onHowWeWorkClick }) {
  ...
  // --- Style for active link border (Desktop Navigation) ---
  const getActiveLinkStyle = ({ isActive }) => ({
    color: isActive ? "#A04D07" : "#737373",
    // Added border bottom style for active link
    borderBottom: isActive ? "2px solid #A04D07" : "none", 
    paddingBottom: isActive ? "2px" : "0", // Add a small padding for spacing
  });
  // -----------------------------------------------------------
  
  // --- Style for active link (Offcanvas/Mobile Navigation) ---
  // Note: For mobile, it's often better to just change the text color/font weight
  // or use a simpler background/border since the links are stacked vertically.
  // I will keep the border bottom but adjust the style slightly.
  const getActiveMobileLinkStyle = ({ isActive }) => ({
    color: isActive ? "#A04D07" : "#737373",
    borderBottom: isActive ? "2px solid #A04D07" : "none",
    ...
    <div className="d-flex fixed-top bg-ff container-adjustment justify-content-between align-items-center">
      ...
      <div className="d-flex align-items-center w-50 justify-content-between d-lg-flex d-none">
        <NavLink
          ...
          // Use the new active style function
          ...
          >
            ...
            >
              ...
              <NavLink
                ...
                // Use the new mobile active style function
                style={getActiveMobileLinkStyle} 
