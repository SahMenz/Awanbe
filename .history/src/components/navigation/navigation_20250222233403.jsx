  ...
  return (
    <div className="d-flex container-adjustment justify-content-between align-items-center">
      ...
      <div className="d-flex align-items-center w-50 justify-content-between d-lg-flex d-none">
        <NavLink to="/" style={({ isActive }) => ({color : isActive ? "#A04D07" : "#737373"})} className="text-decoration-none txt-73 fw-600 fs-16">
          Home
        </NavLink>
        <NavLink style={({ isActive }) => ({color : isActive ? "#A04D07" : "#737373"})} className="text-decoration-none txt-73 fw-600 fs-16">
          About us
        </NavLink>
        <NavLink style={({ isActive }) => ({color : isActive ? "#A04D07" : "#737373"})} className="text-decoration-none txt-73 fw-600 fs-16">
          Our solution
      ...
      <Offcanvas show={show} onHide={handleClose} placement="end" className='' style={{backgroundColor:"#737373"}}>
          ...
          <div className='d-flex flex-column d-lg-flex justify-content-center align-items-center'>
            <div className='d-flex flex-column mb-5 justify-content-between align-items-center' style={{height:"200px"}}>
              ...
              <NavLink style={({ isActive }) => ({color : isActive ? "#A04D07" : "#737373"})} className='hovering txt-16 lh-19 fw-600 text-decoration-none txt-f3' end >About us</NavLink>
              <NavLink style={({ isActive }) => ({color : isActive ? "#A04D07" : "#737373"})} className='hovering txt-16 lh-19 fw-600 text-decoration-none txt-f3' end >Our solution</NavLink>
              <NavLink style={({ isActive }) => ({color : isActive ? "#A04D07" : "#737373"})} className='hovering txt-16 lh-19 fw-600 text-decoration-none txt-f3' end >How it works</NavLink>
            </div>
          </div>
          </Offcanvas.Body>
    </Offcanvas>
