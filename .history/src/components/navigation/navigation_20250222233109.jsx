      ...
      <Offcanvas show={show} onHide={handleClose} placement="end" className='' style={{backgroundColor:"#737373"}}>
          ...
          <div className='d-flex flex-column d-lg-flex justify-content-center align-items-center'>
            <div className='d-flex flex-column mb-5 justify-content-between align-items-center' style={{height:"200px"}}>
              ...
              <NavLink style={({ isActive }) => ({color : isActive ? "#EB1C25" : "#fff"})} className='txt-16 lh-19 fw-600 text-decoration-none txt-f3' end>Find job</NavLink>
              <NavLink style={({ isActive }) => ({color : isActive ? "#EB1C25" : "#fff"})} className='txt-16 lh-19 fw-600 text-decoration-none txt-f3' end>Courses</NavLink>
            </div>
          </div>
          </Offcanvas.Body>
    </Offcanvas>
