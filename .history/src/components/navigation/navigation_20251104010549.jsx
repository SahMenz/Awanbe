...
const navVariants = {
  hidden: { y: -100, opacity: 0 }, // Start off-screen (up) and invisible
  visible: {
    y: 0,
    opacity: 1,
    transition: {
...
function Navigation({onHomeClick,onSolutionsClick, onAboutUsClick, onHowWeWorkClick }) {
  ...
  return (
    // Apply motion.div to the fixed header for the animation
    <motion.div 
      className="d-flex fixed-top bg-ff container-adjustment justify-content-between align-items-center"
      variants={navVariants}
      initial="hidden"
      // whileInView triggers the animation, and once: false ensures it reoccurs
      whileInView="visible"
      viewport={{ once: false, amount: 0 }} 
    >
      <img src={landingPageLogo} alt="Awambe Logo" />
