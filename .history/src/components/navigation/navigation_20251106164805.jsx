...
// Helper hook/logic for Scrollspy (UNCHANGED)
const useActiveSection = (sectionRefs) => {
  ...
  const handleScroll = useCallback(() => {
    ...
    if (sectionRefs.homeRef && sectionRefs.homeRef.current) {
        // Since homeRef is attached to the parent of Hero which has a margin-top,
        // this logic is simplified to default to Home when near the top.
...
function Navigation({ onHomeClick, onSolutionsClick, onAboutUsClick, onHowWeWorkClick, sectionRefs }) {
  ...
  return (
    <div className="d-flex fixed-top bg-ff container-adjustment justify-content-between align-items-center">
      ...
      {/* Desktop Navigation Links - HIDDEN below 992px (d-none, overridden by d-lg-flex) */}
      ...
      {/* Desktop Sign In/Sign Up - HIDDEN below 992px (d-none, overridden by d-lg-flex) */}
      ...
      {/* *** THE HAMBURGER MENU ICON *** The class 'd-lg-none' makes this element VISIBLE on screens below 992px.
        This is the correct logic for mobile visibility. 
      */}
      <div
        onClick={handleShow}
        className="d-flex bg-00 nav-hamburger-icon" // Removed leading space in className
      >
      ...
      {/* Offcanvas/Mobile Navigation (UNCHANGED) */}
      <Offcanvas
        show={show}
        onHide={handleClose}
        placement="end"
      ...
      >
        ...
        <Offcanvas.Body>
          ...
          >
            ...
            {/* Sign In/Sign Up buttons to Offcanvas */}
