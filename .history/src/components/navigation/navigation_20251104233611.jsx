...
function Navigation({onHomeClick,onSolutionsClick, onAboutUsClick, onHowWeWorkClick }) {
  ...
  const activeLinkStyle = {
    color: "#A04D07", // Brown text color for active state
    borderBottom: "3px solid #A04D07", // Brown border-bottom
    paddingBottom: "2px", // Slight padding above the border
  };
  
  const inactiveLinkStyle = {
    color: "#737373", // Gray text color for inactive state
  };
        ...
        <Offcanvas.Body>
          ...
          >
            <div
              ...
              style={{ height: "200px" }}
            >
              {/* Mobile/Offcanvas Navigation Links */}
