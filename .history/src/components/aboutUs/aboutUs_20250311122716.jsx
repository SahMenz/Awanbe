...
function AboutUs() {
  return (
    <div className="mt-5 container-adjustment">
      ...
      <div className="d-flex align-items-center m-3 justify-content-center mt-5 flex-column">
        ...
        <div className="d-flex align-items-center justify-content-center gap-5" style={{height:"400px"}}>
          <div><img src={middleImageLeft}/></div>
          <div className="align-self-start"><img src={middleImageTop}/></div>
          <div><img src={middleImageRight}/></div>
        </div>
