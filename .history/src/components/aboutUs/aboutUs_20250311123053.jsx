  ...
  return (
    <div className="mt-5 container-adjustment">
      ...
      <div className="d-flex align-items-center justify-content-center mt-5 flex-column">
        <div><img src={aboutUsImageLeft}  style={{width:"100vw", maxWidth:"400px"}}/></div>
        <div className="d-flex align-items-center justify-content-center gap-5 mt-5 mx-md-0" style={{height:"400px"}}>
          <div><img src={middleImageLeft} style={{width:"25vw", maxWidth:"400px"}}/></div>
          <div className="align-self-start"><img src={middleImageTop} style={{width:"25vw", maxWidth:"400px"}}/></div>
          <div><img src={middleImageRight} style={{width:"25vw", maxWidth:"400px"}}/></div>
        </div>
        <div><img src={aboutUsImageRight} style={{width:"100vw", maxWidth:"400px"}}/></div>
      </div>
    </div>
  );
}
